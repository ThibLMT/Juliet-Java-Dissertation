import CWE.CWE395_Catch_NullPointerException__basic_01;
		...
		if(args.length != 0) {
			...
			for (String className : args) {
				...
				try {
					...
					/* common.IO.writeLine("classNameWithPackage = " + classNameWithPackage); */
...
/* BEGIN-AUTOGENERATED-JAVA-TESTS-3 */
			(new CWE395_Catch_NullPointerException__basic_01()).runTest("CWE.CWE395_Catch_NullPointerException__basic_01");
